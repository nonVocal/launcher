...
class LauncherConfigTest
{
    ...
    {
        LauncherConfig base = new LauncherConfig("base", false, 400, 400, null, null, null, null, null, null, null);
        LauncherConfig over = new LauncherConfig("over", null, null, null, null, null, null, null, null, null, null);
    ...
    void mergeOver_nullFieldsFallBackToBase()
    {
        LauncherConfig base = new LauncherConfig(
                "baseRoot", true, 800, 600, null, "exp.exe", "nano", null, "ICONS", true, null);
    ...
    void mergeOver_allFieldsOverridden()
    {
        LauncherConfig base = new LauncherConfig("base", false, 400, 400,
                List.of("a"), "e1", "ed1", List.of("X"), "ICONS", true, null);
        LauncherConfig over = new LauncherConfig("over", true, 800, 900,
                List.of("b"), "e2", "ed2", List.of("Y"), "HAMBURGER", false, null);
    ...
    {
        LauncherConfig global   = new LauncherConfig("globalRoot", false, 400, 400, null, null, null, null, null, null, null);
        LauncherConfig instance = new LauncherConfig(null, null, 600, null, null, null, null, null, null, null, null);
        LauncherConfig explicit = new LauncherConfig("explicitRoot", null, null, null, null, null, null, null, null, null, null);
    ...
    void withDefaults_preservesExplicitValues()
    {
        LauncherConfig c = new LauncherConfig(
                null, true, 1024, 768, null, null, null, null, null, null, null).withDefaults();
    ...
    void saveAndLoad_simpleScalarFields(@TempDir File tmp) throws IOException
    {
        ...
        LauncherConfig original = new LauncherConfig(
                "C:\\Apps", true, 700, 500, null, "explorer.exe", "code", null, "HAMBURGER", false, null);
        original.save(f);
    ...
    void saveAndLoad_priorityList(@TempDir File tmp)
    {
        ...
        new LauncherConfig(null, null, null, null, priority, null, null, null, null, null, null).save(f);
    ...
    void saveAndLoad_actionOrder(@TempDir File tmp)
    {
        ...
        new LauncherConfig(null, null, null, null, null, null, null, order, null, null, null).save(f);
    ...
    void saveAndLoad_pathWithBackslashes(@TempDir File tmp)
    {
        ...
        new LauncherConfig(path, null, null, null, null, null, null, null, null, null, null).save(f);
    ...
    void saveAndLoad_stringWithEmbeddedQuotes(@TempDir File tmp)
    {
        ...
        new LauncherConfig(null, null, null, null, null, null, editor, null, null, null, null).save(f);
    ...
    {
        File f = new File(tmp, "config.json");
        new LauncherConfig(null, null, null, null, null, null, null, List.of(), null, null, null).save(f);
